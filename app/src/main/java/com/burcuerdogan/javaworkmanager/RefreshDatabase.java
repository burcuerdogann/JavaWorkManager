package com.burcuerdogan.javaworkmanager;
...
public class RefreshDatabase extends Worker {
    ...
    private void refreshDatabase(int myNumber) {
        SharedPreferences sharedPreferences = myContext.getSharedPreferences("com.burcuerdogan.javaworkmanager",Context.MODE_PRIVATE);
